...
INSERT INTO Project (ProjectID, ProjectName) VALUES (1, N'Main');
INSERT INTO Project (ProjectID, ProjectName) VALUES (2, N'Other');

SET IDENTITY_INSERT Project OFF
GO
SET IDENTITY_INSERT ProjectSection ON
-- Insert project sections
INSERT INTO ProjectSection (SectionID, ProjectID, SectionName, SheetName, SortOrder) VALUES (1, 1,  N'Rekapitulacija', N'Rekapitulacija', 1);
INSERT INTO ProjectSection (SectionID, ProjectID, SectionName, SheetName, SortOrder) VALUES (2,  1, N'Priprava in razvod GM-25_-15', N'Priprava in razvod GM-25_-15', 2);
INSERT INTO ProjectSection (SectionID, ProjectID, SectionName, SheetName, SortOrder) VALUES (3,  1, N'HV29-35_PTV11_VMEH', N'HV29-35_PTV11_VMEH ', 3);
INSERT INTO ProjectSection (SectionID, ProjectID, SectionName, SheetName, SortOrder) VALUES (4,  1, N'Hladilna voda HV20-30', N'Hladilna voda HV20-30', 4);
INSERT INTO ProjectSection (SectionID, ProjectID, SectionName, SheetName, SortOrder) VALUES (5,  1, N'SKUPNO', N'SKUPNO', 5);
INSERT INTO ProjectSection (SectionID, ProjectID, SectionName, SheetName, SortOrder) VALUES (6,  1, N'KVALIFIKACIJE', N'KVALIFIKACIJE', 6);
INSERT INTO ProjectSection (SectionID, ProjectID, SectionName, SheetName, SortOrder) VALUES (7,  1, N'SPLOŠNO', N'SPLOŠNO', 7);

SET IDENTITY_INSERT ProjectSection OFF
GO

GO
SET IDENTITY_INSERT Component ON
-- Insert components
INSERT INTO Component (ComponentID, SectionID, Position, Description, Quantity, Unit, SupplyPerUnit, InstallationPerUnit, TotalPerUnit, Total, SortOrder)
...
NULL, NULL, 32);
INSERT INTO Component (ComponentID, SectionID, Position, Description, Quantity, Unit, SupplyPerUnit, InstallationPerUnit, TotalPerUnit, Total, SortOrder)
VALUES (130, 4, N'D3.14', N'Lovilnik nesnage, primeren za stolpno vodo. Temperatura medija do 40°C, tlak do 6 bar(g). Skupaj z izpustnim čepom. Vključno s spojnim, vijačnim, tesnilnim materialom in funkcionalno montažo.
Tehnične karakteristike:
- Priključek: prirobnični, EN1092-1, PN16 
- Material: siva litina (EN-GJL-250)
- Sito: standardno, nerjavno (1.4301)
